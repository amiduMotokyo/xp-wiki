...
* 异常状态持续时间机制与仪式之法准备时间机制同步

#### 魔法

* 对气盾魔法进行了小重置
* 气流的位移效果现在不再限定气流强度大于等于5，并增加了抵抗难度
* 地刺术20级进阶修改：增加魔法威力以及异常状态的抵抗难度
...
* 天狗国家传特性重置
* 所有开局给-10检定值奖励的，现在拆经历点阶段给，初始给4，每5点再给2，最终给10
* 实装种族经历点补正值
* 已有种族的种族特性修改：狼人加了个半血伤害倍率+0.3，提了1点补正值；蚁族种族特性小重做；高阶骷髅和高阶僵尸种族特性重做；大鸿去除了一个意义不明的仪式之法种族特性
* 新增种族：大恶魔、小恶魔、二臂蚁族
* 沙族人和魅魔暂时不可选

#### 规则

* 明确规定：子弹时间中所有有关打断类的强势效果，目标的行动点与SP消耗不返还，其他资源会返还
* 新增了天命的编写准则以及范例选择

#### 魔法

* 统一天狗国阴阳术素材获得方式与获取价格
* 开拓大神造出的船体和风帆被攻击时走盾牌防守流程，风帆额外给6格范围内的队友上惯击或惯防，水之领域现在最多叠2层，水手之力可以给攀爬奖励骰，生成船只和风帆需要1行动轮准备时间，但也可以立刻生成质量较差的版本充当掩体或障碍物
* 八咫鸟大神部分看感知范围的阴阳术现在全改成看施法范围，集群领域效果规范描述
* 圣光魔法的素材手抄经文现在可以购买获得，但购买来的不能用于大诵经版本的圣光魔法
* 锻造大神的磐石赐福从原来的护甲值+2改成护甲值+1且额外生命+3
* 荒胫大神的巧言善辩重做，足之印记规范描述
* 仪式之法的节约素材效果从每行动轮一次改为每场战斗最多2次

#### 武器

* 御币的施法范围适用范围更改：仅对除仪式之法外的3种流派魔法无效

#### 技能

* 缴械和妙手的大招从去除“外生型”词条改为无法通过子弹时间解除
* 坚定和劝服印记层数上限+2，劝服最终效果需要消耗的印记层数+2
* 战术印记现在都需要消耗2sp来消耗
* 给搬运技能加了个常规行动：擒抱

#### 职业

* 原本哨兵2级给的感知15级“快速反应”的反制效果现在变成快速反应固有
* 哨兵2级新给技能：每场战斗1次，抵消一次使用道具的破绽
* 哨兵6级“跳远”改为“运动健将”，让攀爬效率也提升
* 武者4级给的效果拆分：武具精通中的武器力量阈值-10不再需要举重若轻15级
* 巨兽猎手2星职业“巨兽猎兵”、“追迹猎手”、2星副职“狩猎大巧思”重置完成
* 授权教授获得的魔法也得是准学学派里的，看书施法依然需要行动点+1
* 神社巫女系职业重置
* 神社新2星副职：卜部
* 诵经师的苦修狂欢技能改为每受到10％HP伤害，减少一个圣光魔法半行动轮准备时间
...
* 话术规则更新
* 经历点附赠经验值公式修改
* 语言规则极简化：去除熟练度机制，去除方言设定，降低掌握语言的经历点花费，明确长休学习语言的花费，同步更新所有与语言有关的描述
* 学习和灵感二合一为灵知，并重新设计其升级技能，同步修改所有学习、灵感、学霸、学神、博闻强记有关的描述和熟练项
* 水性的15级和30级技能位置调换，30级技能改为上三属性+5
...
* 影行者“通晓外语”新增机制：对语言不通者也可以使用话术，但会失去所有奖励骰
* 学院分家后，123星职业也分家了
* 修改了魔法大学社群简介的一些描述文本
...
* 规范了包括防守检定在内的几个专有名词
* 对全体措手不及效果设置了导航
* 代防削弱：上限2范围，需要花费1ap才能代
* 长休当中的能力锻炼现在只能把数值锻炼到40

#### 武器

* 实装魔法武器，锻造、铁匠铺对魔法武器的升级有额外收费
* 杖系武器重做并挪入魔法武器当中（原来杖系位置的文案先放着占个位置）

#### 职业

* 魔法学徒“魔法飞弹”改成“基础学识”，为原法杖30级中的一个效果
* 魔法教授的“杖”熟练项改成任意魔法武器
* 巫妖科技、圣堂社群职业新增一个“典籍”武器可选熟练项
* 牧师“便携圣典”适配魔法武器规则
* 诵经师技能“高速吟唱”改为“控速吟唱”，新增增加半回合的可选项，而且触发时机放宽
* 神社职业重置进行中（没改完）
* 影行者职业有关破影一击的描述修改
...
* 博闻强记不能用来提升武器熟练度
* 蹲伏姿态增强：原中级技能下放给所有人，初级增加近战闪避检定，中级换成闪避失败视为防御失败
* 夹击削弱：同一组中的2人只能触发夹击破绽一次
* 背靠背削弱：高于1层的层数战术奖励减半，不适用升级技能
* 坚守姿态调整：第一次代防免消耗
...
* 亡灵法术平衡性整体修改
* 血法的血液武器现在不能用武器通用升级技能

#### 职业

* 明光学联平衡性整体修改
* 冠军百夫长技能修改：前两个战法从纯数值提升改为新机制，魔式反思增加消耗，魔式蛮干增加惩罚
...
* 心神法过载效果修改：作用目标数+1挪到了3级，删除了2个语焉不详几乎没人用的过载效果，限制了作用目标数和魔法效果的叠加作用
* 轻盈术削弱：不再能适用所有行动，但给了额外一次子弹时间机会以及散装上级冲锋
* 传送术削弱：加了点高数值场合下的限制
* 隐身术修改：读条获得移动点效率降低，但可以立刻行动
* 跳转术削弱：层数获取效率降低

#### 职业

* 先锋百夫长的缠斗增加一个专门给远程武器专精的选项
* 先锋百夫长里升级“惯性防御”的其中一个效果挪到3星里去
* 新职业：冠军百夫长
