...
低阶物品传送|10|对5格范围内一目标地点使用，将身上物品传送到指定地点，若为消耗品则可对目标地点的目标人物使用（可闪避）|特制传送瓶x1|立刻生效|无
高阶阴影传送|20|生效后可以在本回合自己行动轮内任意时刻进行总共3次无任何消耗的传送（可两种混合使用）（此效果使用的传送不产生任何经验值）|防护水晶x5 防护立场发生器x1|一回合|头
...
名称|SP消耗|效果|所需材料|准备时间|弱点
:--:|:--:|:--:|:--:|:--:|:--:
低阶阴影遮蔽|10|选定感知范围内的3x3x2范围，使该地点被模糊化|影雾x1 
特制传送瓶x1|半回合|头部
...
!!! info "复制幻影"
    该召唤物无敌，没有碰撞体积，拥有和法术使用者完全一样的属性、熟练度、技能、外貌、装备。被近战攻击命中后会使得攻击者造成一次破绽。发现后可以对其进行魔法感知进行识破鉴定，被识破后也不会消失。
...
名称|SP消耗|效果|所需材料|准备时间|弱点
:--:|:--:|:--:|:--:|:--:|:--:
范围阴影结界|20|将整个场地罩入暗影当中，全部地点视为模糊化，且感知范围除施法者以外所有单位降低至5，所有己方单位获得“阴影化”效果。|影雾x6|两回合|头部
