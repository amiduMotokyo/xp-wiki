...
中级|轻巧刻痕|若该护甲的护甲值提升量小于等于1，则每回合获得0.5额外行动点|该护甲为轻甲且尚未印刻轻巧刻痕
...
特级|广博刻痕|该护甲的学识刻痕现在允许指定所有泛用技能；指定一项任意技能（包括特战、魔法等），该护甲每有一个与其共通挂钩属性的学识刻痕，其阈值与熟练度上限+2|全身护甲已印刻至少3个学识刻痕
特级|背水刻痕|每有一件护甲额外生命值归零，全阈值+2，该刻痕即使护甲额外生命值为0也有效果|全身护甲均至少提升过2次减伤与额外生命
特级|超载刻痕|每场战斗限一次，该护甲受击且额外生命大于一半时可以发动，一回合内该护甲的护甲值变为1.5倍，减伤率+20%，持续时间结束时该护甲额外生命归零|无
特级|注能刻痕|将该护甲印刻的疾速刻痕、格挡刻痕、强韧刻痕中的“战斗结束前失效”修改为“一回合内失效”且效果变为两倍|该护甲已印刻疾速刻痕、格挡刻痕或强韧刻痕
