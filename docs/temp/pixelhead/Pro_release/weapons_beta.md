...
此外，武器在升至5、9、13、15级时会迎来质变，这会分别为武器提供一个初级、中级、上级、特级印痕位并同时印刻对应的印痕，默认四种印痕位各一个。特别的，你也可以选择将一个高级的印痕位拆分成两个低一级的印痕位并印刻，但不能反向操作且同种印痕无法超过三个。
...
特级|智识刻痕|该武器已印刻求知刻痕的话，进攻结束后可以以将那次获得的经验降为0为代价，使下次进攻检定获得相当于（经验下降量×2）的阈值奖励，若该效果提供的阈值奖励大于等于8，则再获得一枚奖励骰|该武器已印刻求知刻痕
特级|猛袭刻痕|该武器已印刻冲劲刻痕及无羁刻痕的话，使用该武器进攻时，可以以进攻结束时额外叠加5点进攻阈值衰减为代价，令当次阈值+10，且因子倍率进一步提升至2<br>受击时，若对抗失败，则当次因子倍率提升至1.2|该武器已印刻无羁刻痕
特级|控驭刻痕|该武器已印刻奋发刻痕的话，使用该武器进攻且对抗失败时，若对方阈值高于你，则每高10点便令下次进攻检定值-7|该武器已印刻奋发刻痕
特级|混沌刻痕|战斗开始时，进行一次幸运检定，若成功则本场战斗该武器进攻阈值获得（差值/5四舍五入）奖励，若失败则本场战斗该武器进攻检定值获得（差值/5四舍五入）奖励|无
