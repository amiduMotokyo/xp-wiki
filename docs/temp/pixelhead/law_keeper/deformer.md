...
“巨尾”|战技|触发|8|背后出现占地一格的尾巴，获得5点临时力量，可以主动进行一次阈值为（当前力量+10）的检定，若成功则对尾巴所在格范围1内的其他角色造成（当前力量/10）的固伤。<br>每回合开始时需支付2点SP维持状态，否则状态解除。<br>对律法守护者以外的角色使用时，改为获得-5点临时力量。
...
:--:|:--:|:--:|:--:|:--:|:--:
《龙之秘典》|魔力|20|1|6|施法范围7<br>每回合最多两次，与施法范围内任意单位的抵抗或魔法抗性对抗，若成功，则可消耗SP对其附加任意已习得的龙化秘法的最弱版本并令其流失4点SP，持续一回合。
