...
4|7500通|升级姿态“反击姿态（原始）”、“冲锋（原始）”：且本技能附加的战术奖励额外带有令检定值-5的效果。
...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
“骇翼”|战技|触发|8|获得飞行能力且在空中结束回合时进行稳定的行动点变为1，枪系武器可以挂钩敏捷进行检定。<br>每回合开始时需支付2点SP维持状态，否则状态解除。<br>对律法守护者以外的角色使用时，目标移动行动点加倍，仍需维持稳定且消耗变为3。
