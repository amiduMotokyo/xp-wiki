...
* 初始：对目标附加“不由自主”状态
* 10级进阶：“不由自主”状态升级：状态中抵抗阈值-5
* 20级进阶：目标+1
* 30级进阶：“不由自主”状态升级：解除手段1变为：1行动轮后自动解除
* 30级名称改变：人格抽取
...
* 10级进阶：魔法威力提升为5
* 20级进阶：“引燃”效果升级：在原有基础上，再在每次增加<a href="../mark/#烧伤印记" target="_blank">“烧伤印记”</a>的基础上增加1层。即，若本次造成5的火焰伤害，则将会累加2*5+1=11层。
* 30级进阶：魔法威力提升为8
* 30级名称改变：爆燃预兆
...
* 初始：得知对象正在进行的仪式之法的1个弱点。
* 10级进阶：效果增加：得知对象1件防具的全部数值（具体部位依对抗结果而定）
* 20级进阶：效果增加：揭示对象的1个专属技能内容
* 30级进阶：可以放弃以上三个效果，使得你的下一次对该对象的攻击必然暴击。这个效果不会改变对抗的差值，但是会将结果改写为你的成功，总伤倍率+0.5倍
* 30级名称改变：透视术
