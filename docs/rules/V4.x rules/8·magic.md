...
根据释放的魔法难度确定斗法的轮数，一般默认初级魔法3轮，中级魔法5轮，上级魔法7轮。被动方使用“魔法感知”检定对抗发起方的魔法检定，三局两胜，五局三胜，七局五胜。整个过程中，只要被动方成功的次数超过发起方，即视为被动方斗法成功，阻止发起方释放这个魔法；反之，被动方无力阻止发起方释放魔法，此时转入2.1执行之后的流程。整个过程经验只增长一次。
