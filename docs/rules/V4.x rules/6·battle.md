...
!!! question "HP归零了怎么办"
    如果对手没打算下死手，且你的HP并没有`低于你体质负值的一半`，你只是陷入濒死状态与倒地状态，HP上限固定到0，等人来营救即可。要注意的是，此时你会失去你的行动轮：同一回合内到你的行动轮，若你濒死，会延后行动轮到本回合的末尾，如果这一回合结束时你仍然没有解除濒死状态，那你就会丢失你这一回合的行动轮。
