...
!!! warning "心灵类魔法与三大魔法流派的互斥性"
    ...
    自然，心灵类魔法不算三大魔法流派中的任意一个。使用需要消耗SP，一行动轮只可以用一次，击发类型均为定点型。

!!! example "心灵类魔法的被动"
    获得首个中级魔法时，可以获得其对应分支的被动。获得三个上级魔法时，可以再选择获得一个未拥有的被动。
...
* 30级进阶：目标一行动轮内从<a href="../../status/mark/#精神损伤" target="_blank">“精神损伤”</a>和<a href="../../status/mark/#分心印记" target="_blank">“分心印记”</a>中获得的效果+1倍。
* 30级名称改变：专注毁损
...
* 初始：抵抗因魔法造成的异常状态时，可消耗1AP，以本法术代替抵抗检定，检定阈值+2X，若成功则完全防止状态的附加
* 10级进阶：若失败则弱化状态或减半印记
* 20级进阶：SP消耗-2，检定值-X，获得一枚奖励骰
* 30级进阶：现在也可用于对抗话术或心理学，AP消耗-0.5
* 30级名称改变：拒斥强念

*“你们要的对抗心灵法术的办法，满意了吧？”*

*“什么叫做‘通过精密操纵魔法粒子来针对性的产生反魔法粒子干涉波以抵消施法者意图在魔操中进行投射的非客制性且具有明确指向性的反机能指令’？这都啥跟啥啊，笔记…全是塔拉呼那语？还有密文？？？见鬼…”*
...
* 20级进阶：<a href="../../status/normal#心神不稳" target="_blank">“心神不稳”</a>状态下，防守阈值衰减速度+0.5倍。
...
* 30级进阶：伤害变为4+X，目标本次魔法抗性与闪避检定获得一枚惩罚骰。
* 30级名称改变：毁灵爆破
...
* 初始：选择X个心灵类法术分支，用本技能与本技能自身对抗，本行动轮内所选分支的法术可用次数变为2，检定值减少（差值因子×3）点。
...
* 10级进阶：<a href="../../status/normal/#软弱" target="_blank">“软弱”</a>状态持续时间变为2行动轮。
...
* 初始：赋予目标持续X行动轮的<a href="../../status/normal/#认知失调" target="_blank">“认知失调”</a>，该法术不能连续两行动轮对同一目标使用
* 10级进阶：<a href="../../status/normal/#认知失调" target="_blank">“认知失调”</a>解除条件2改为每8点伤害减少1行动轮。
* 20级进阶：<a href="../../status/normal/#认知失调" target="_blank">“认知失调”</a>持续时间改为X+1行动轮，次数改为1+(释放时差值因子/2)
...
自己的回合结束时，每释放过一种不同分支的心灵类法术，回复2点HP与SP。

#### 进阶效果

自己的回合结束时，每释放过一种不同分支的心灵类法术，回复2点HP与SP。用过至少3种的话，额外回复6点HP与SP，否则下行动轮释放首个本轮未释放过的分支的心灵类法术时行动力消耗-2。
