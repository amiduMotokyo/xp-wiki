...
!!! success "气流"
    ...
    另外，受到气流影响的所有角色需要进行抵抗检定，难度为差值因子×5，若检定失败，并被迫免行动点向气流方向移动（气流强度/2四舍五入）格。对于空中的角色（或者是云之类的漂浮物）检定失败，则会露出一个破绽，并被迫免行动点向气流方向移动（气流强度）格。
...
* 10级进阶：目标最大地区扩展为4×4
* 20级进阶：<a href="../../../status/terrain/#气盾" target="_blank">“气盾”</a>现在可以使远程攻击伤害倍率-0.3
* 30级进阶：现在穿越<a href="../../../status/terrain/#气盾" target="_blank">“气盾”</a>所在占地格需要消耗额外的2点行动点（踏入1，踏出1），效果2现在只消耗2SP，一行动轮可以使用5次
* 30级名称改变：空气墙
...
* 初始：目标附加<a href="../../../status/normal/#轻盈" target="_blank">“轻盈”</a>状态（禁用过载效果中的“魔法效果+0.5倍”条目）
* 10级进阶：<a href="../../../status/normal/#轻盈" target="_blank">“轻盈”</a>状态效果新增：全身装备力量阈值-10
* 20级进阶：<a href="../../../status/normal/#轻盈" target="_blank">“轻盈”</a>状态效果新增：目标获得如同上级冲锋战术的效果；若目标原本冲锋战术就是上级，则免除多次冲锋前的蓄势行动点消耗
* 30级进阶：<a href="../../../status/normal/#轻盈" target="_blank">“轻盈”</a>状态效果新增：目标获得飞行的能力；原先就能飞行的，在空中停留不再因护甲减少行动点恢复量
* 30级名称改变：燕行术
