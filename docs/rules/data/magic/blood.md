...
* 初始：以自身为中心产生区域为【（检定差值/10四舍五入，最多为3）+（额外消耗/5最大3）】/3圈范围的<a href="../../status/terrain/#血雾" target="_blank">“血雾”</a>。除释放回合每回合消耗HP以自身为中心开始向外扩散该消耗/3（向上取整）圈范围，其中的单位会强制受到<a href="../../status/mark/#猩红之灾" target="_blank">“猩红之灾”</a>的影响。
