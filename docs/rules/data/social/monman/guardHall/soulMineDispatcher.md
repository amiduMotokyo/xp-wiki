...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
局域网|战技|被动|0|将自愿的队友加入到你组建的局域网中，随时汇总其中所有成员的魂源，每一位成员都可以自由地使用汇总的魂源，且可以自由地和局域网的其他成员进行脑内交流
魂源调配|战技|被动|0|每回合2次，你可以将原本只能以自身为目标的魂源法术改为对局域网内的某一目标有效，将其视为受术者
统合感知|战技|被动|0|在局域网中的所有成员可以共享彼此的感知范围，且你所有涉及感知范围的能力可以对感知范围外的局域网内部成员有效
