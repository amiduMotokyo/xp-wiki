...
* 固守战法：所有感知范围包含你的我方单位获得1范围的<a href="/rules/V4.x rules/12.properName/#代防" target="_blank">代防</a>，若代替防御，则检定获得一枚奖励骰
...
!!! success "终极版战法"
    进击战法：所有感知范围包含你的我方单位进攻检定值获得-4奖励，总伤倍率+0.2；本回合仅一次对某目标进攻后对其附加一层<a href="../../../../status/mark/#脆断印记" target="_blank">“脆断印记”</a>

    固守战法：所有感知范围包含你的我方单位获得1范围的<a href="/rules/V4.x rules/12.properName/#代防" target="_blank">代防</a>，若代替防御，则检定获得一枚奖励骰；本回合仅一次受到某目标进攻后对其附加一层<a href="../../../../status/mark/#折戟印记" target="_blank">“折戟印记”</a>
...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
魔式反思|战技|触发|0|当你的一次进攻或防守检定或对抗失败后，获得一层<a href="../../../../status/mark/#战术印记" target="_blank">“战术印记”</a>，消耗该印记层数时，你需要花费2SP<br>当你的一次进攻或防守检定或对抗失败，但你通过某种手段改为了成功，则可以选择消耗3点SP来将其视为满足触发条件
魔式蛮干|战技|触发|5|自身回合开始时选择触发：本回合你的“魔式问候”、“魔式防备”、“遇强则强”战技暂时失效，防守检定获得一枚惩罚骰，取而代之的是本回合你的所有进攻的伤害倍率+0.3，且无视所有伤害倍率减少的效果（若为魔法，则闪避成功带来的默认伤害倍率减半效果除外）
战斗，爽|战技|被动|0|去除对决战法中“进攻剩余50％及以上体力的目标”的条件<br>若切换到对决战法时“魔式蛮干”处于触发状态，选择转移受益对象时可以把“魔式蛮干”的效果也转移给目标我方单位，同时自己仍然需要承受“魔式蛮干”的负面效果