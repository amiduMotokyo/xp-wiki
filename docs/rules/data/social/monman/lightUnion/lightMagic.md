...
* 初始：以捆绑法召唤一个持续2回合，照亮周边4格范围，且同时只能存在一个的光球，每次施术者回合结束时，光球对照明范围内2个随机敌人造成威力为2的魔法伤害(以本法术阈值作为检定内容，衍生攻击若成功可获得固定2点经验值，敌人总数小于2时允许重复索敌)
...
* 初始：目标2×2范围内降下光柱，对所有单位造成8魔法伤害且抵抗判弱化版本的致盲<a href="../../../../status/normal/#致盲" target="_blank">“致盲”</a>
