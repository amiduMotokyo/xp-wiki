...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
居合斩|特殊战技|与武器一致|5|在“收刀状态”下，对露出破绽或<a href="/rules/V4.x rules/12.properName/#措手不及" target="_blank">措手不及</a>的目标拔出武器进攻，检定值-4，伤害+0.5倍<br>每多花费1行动点，蓄1层力，检定值再-8，伤害再+0.25倍，最多蓄1层力<br>拔出武器无需额外消耗行动点
心眼|战技|被动|0|你的回合中，你可以消耗1点行动点，来获得1层心眼（最多12层）<br>你可以消耗1层心眼，来用心理学检定代替闪避检定，分别计算衰减<br>使用居合斩进行额外蓄力时，你可以消耗1层心眼来代替花费1行动点<br>你可以消耗x层心眼（x<=2），使你的交战状态判定半径+x，若该范围内的敌人露出破绽，你可以免行动力向其移动x格且不会露出破绽
集心迸发|战技|触发|0|前置冷却时间1行动轮，消耗4层心眼，免除所有负面异常状态与印记，回复50％的SP，本行动轮内你的居合斩去除“对露出破绽或<a href="/rules/V4.x rules/12.properName/#措手不及" target="_blank">措手不及</a>”的限定，持续1行动轮<br>一场战斗限用一次
纳刀术|战技|被动|0|战斗开始时，即拥有2层心眼<br>收起主武器不需要花费行动点，且可以在行动轮外执行收武器行动<br>每行动轮可使用居合斩次数+1次，且你可以选择放弃第二次使用的机会，来让本次居合斩无视目标一半的护甲值
