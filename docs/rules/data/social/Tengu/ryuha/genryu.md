...
* 初等技能：替身肖像
* 初等技能升级：替身肖像现在可承受2次攻击，且对受影响的敌人产生1层威压效果
* 中等技能：精神集中
* 高等技能：执念
...
精神集中|战技|触发|5|使用此技能后，本回合内所有能被打断的技能都不会被打断，且进行的所有其他行动都可以花费额外1点行动点来获得检定值-8的奖励（最多-24）
执念|战技|被动|0|编辑的精神力是永远用不完的！若你的精神力不够支持你使用某项能力，你可以以多花费1倍行动点为代价让这项能力不耗费精神力，每回合限用一次
...
死缠烂打|战技|触发|5|没达到取材的目的我是不会罢休的！若你对你的某一检定不满意，你可以重新再进行一次这样的检定，每一个检定最多触发2次，且只能应用触发后的结果
...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
闪光灯问候|战技|触发|5|选定感知范围内的敌人，消耗2行动点，用摄影检定与对方的抵抗检定对抗，使目标陷入<a href="../../../../status/normal/#致盲" target="_blank">“致盲”</a>状态；若大成功，目标陷入<a href="../../../../status/normal/#晕眩" target="_blank">“晕眩”</a>（非弱化版本）状态；每回合限用一次
