...
4|升级姿态“坚守姿态（中级）”：对抗火器时的防御阈值不再减半，额外获得1范围的<a href="/rules/V4.x rules/12.properName/#代防" target="_blank">代防</a><br>升级被动战术“背靠背（中级）”：可以以将任意层本战术的战术奖励数值降为2为代价，抵消进攻者等量层的战术奖励。
...
7|卫士职业特性升级：每有一个由你提供全身护甲值的队友，防御阈值+8，进行<a href="/rules/V4.x rules/12.properName/#代防" target="_blank">代防</a>时全身护甲+1。
