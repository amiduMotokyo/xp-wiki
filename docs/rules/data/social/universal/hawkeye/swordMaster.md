...
3|战技“审判之刃”升级：可以对boss型目标生效，但效果变为0.5x％最大HP的固伤，一行动轮限用1次<br>战技“斩箭术”升级：去除“非<a href="/rules/V4.x rules/12.properName/#措手不及" target="_blank">措手不及</a>的状态下”与“除火器外”的限制条件
...
斩箭术|战技|触发|3|非<a href="/rules/V4.x rules/12.properName/#措手不及" target="_blank">措手不及</a>的状态下，当受到来自正面的远程物理攻击（除火器外）时，可消耗一次子弹时间的机会，来让这次远程物理攻击无效