...
继承旗手的职业特性，光环效果能对自己生效；允许在准备<a href="/rules/V4.x rules/8·magic/#_19" target="_blank">仪式之法</a>的同时执行任何行动；拥有特殊资源：神圣充能，每场战斗开始拥有1点充能，每使用一个圣光系仪式之法时，此充能+1，大诵经版本+2。
...
3|14000通|职业特性升级：每场战斗开始拥有2点神圣充能，每回合结束可以自动增加1点神圣充能<br>习得一个中级圣光魔法，或者解锁一个已习得的中级圣光魔法的大诵经版本
...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
圣疗|战技|触发|0|本回合若你的“急救”次数已用完，你可以消耗1点神圣充能再次使用“急救”<br>使用“急救”后，你可以消耗1点神圣充能来获得以下效果二选一：重新再检定一次，取较好的结果；或者治疗量×1.5倍（两者可同时生效，但不可自叠）
祝福武器|战技|触发|0|进攻造成伤害后，你可以选择消耗1点神圣充能，来使本次进攻造成的伤害额外附加（魅力/8四舍五入）点固定伤害，对于亡灵生物而言，则是额外附加（魅力/5四舍五入）点固定伤害（额外伤害可以选择是否受到这一击的倍率影响）
