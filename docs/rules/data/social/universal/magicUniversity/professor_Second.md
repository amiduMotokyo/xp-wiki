...
魔法教授是指在苏尔伍德第二魔法大学毕业，对某一领域魔法有较深造诣，且愿意留校从事教育工作的教师。相比中央联合魔法大学的授权教授，魔法教授能够开创性地发明新式魔法，还能再短时间内大概解析其他人的施法套路。

## 必要条件

* <a href="../postgraduate_Second" target="_blank">魔法进修生</a>职业等级达到5级
* 某魔法流派等级达到3级及以上
* 已获取“传授”的特殊技艺
* 选择2个<a href="../magicUniversity_Second/#学生自治组织信息" target="_blank">学生自治组织</a>作为指导老师，提供熟练技能
* 如果选择武艺交流会指导，熟练项可替换为：攀爬、跳跃、缴械三选二
* 如果选择学徒自治会指导，熟练项可替换为：任选2种话术
* 无法选择<a href="../professor_Central" target="_blank">授权教授</a>职业，但可以通过办理转校（需符合对方职业必要条件，所选学院不可变）把本职业等级替换为对方职业等级
...
允许在感知范围内其他人使用任意魔法时，在魔法感知检定通过的前提下，再通过一个成功的灵知检定来学会对方释放的魔法。任何等级的魔法都只需如此一次即可习得。

若你对应系的“xx系精通”特殊技艺没有达到10/20级，则无法通过这种方式学会对应系的中级/上级魔法

!!! success "新增长休效果：顿悟"
    消耗2点长休行动点，进行灵知检定，一次成功的顿悟可以获得1点顿悟点数。顿悟点数可以用来学习魔法：学会初级魔法需要1点顿悟点数，中级魔法2点，上级魔法3点，且此举获得经验值×2。
