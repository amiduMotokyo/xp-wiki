...
12|为战技“龙魂调谐”新增主动效果：一回合一次，为自己附加最多5点精神损伤并回复那个数值的HP与SP。<br>升级战技“虚斩”：若通过成功的乔装检定使用本战技，则检定值-8。<br>升级战技“断魂斩”：改为对范围5以内的最多3个目标造成伤害。
...
<font color="#800080">龙魂调谐</font>|战技|已转化的被动|0|受到攻击时，若对方的精神损伤数值低于你，则令对方获得那个差值的精神损伤。
...
灵感分流|战技|被动|0|主动攻击精神损伤数值不为9的目标时，若本次攻击附加的精神损伤会令目标的精神损伤数值超过9，则你可以以不附加超出部分的精神损伤为代价，获得那个数值的渊墨。记录并累加因本战技获得的渊墨，记录的数值不会减少，达到25时，转化本战技。
<font color="#800080">灵感分流</font>|战技|已转化的被动|0|进行会附加精神损伤的攻击时，可以自由选择附加、不附加或改为减少那个数值的精神损伤，根据选择的模式获得效果：<br>不附加：回复那个数值的SP<br>减少：获得那个数值两倍的渊墨
...
尸油精|在目标地点及周围一圈产生毒雾，毒雾内部的角色全阈值有-12惩罚，在毒雾内移动时每消耗1行动点变受到1点精神损伤|250
