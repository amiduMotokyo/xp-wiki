...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
渊刻影卫|战技|被动|0|每轮每移动3格，下3次使用爪的攻击行动点消耗与阈值衰减减半。攻击行动轮开始时未发现你的目标时阈值+8。处刑人作为主职时禁用哨兵以外基础职业带来的收益。
...
夺命之连|战技|被动|0|造成击杀时，获得2点仅可用于攻击的额外行动点，本轮内爪的攻击变为二连击，也可以消耗一具不由自己击杀的尸体触发该的效果（半具尸体时不会获得额外行动点）。
