...
!!! info "投掷物品与投掷范围"
    ...
    无论是投掷物品还是投掷飞镖系武器，初始的攻击范围都是投掷者的力量或敏捷/8（四舍五入）。

名称|挂钩属性|力量阈值|攻击范围|武器威力|特殊效果
:--:|:--:|:--:|:--:|:--:|:--:
飞镖|力量/敏捷|20|力量或敏捷/8（四舍五入）|4|初始弹药量：8<br>允许在后方圆环处挂载合适的物体<br>涂抹药物后，对方抵抗判定异常状态获得+10惩罚
飞刀|力量/敏捷|25|力量或敏捷/8（四舍五入）|7|初始弹药量：8
手里剑|力量/敏捷|20|力量或敏捷/8（四舍五入）|5|初始弹药量：8<br>可选择最多两连发（效果与弩系武器升级技能中的连射类似）
