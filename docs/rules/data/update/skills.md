...
无武器时的徒手攻击也是用此技能进行检定，默认的武器范围为1，武器威力为力量/10四舍五入。
...
熟练度等级|名称|战技/特殊战技|类型/挂钩属性|消耗SP|效果
:--:|:--:|:--:|:--:|:--:|:--:
15|巧取|特殊战技|敏捷|5|战斗中，若你处于对方不可见的状态下，用本技能与对方防守检定（拼刀除外）对抗，若成功，偷取对方身上可见的可携带装备
...
!!! info "注：关于隐身和普通潜行"
    ...
    识破隐形：若处于某角色的感知范围/3的范围内（第一条件），或者对某目标做出敌意行动后（第二条件），需要用潜行与目标的侦查或聆听进行对抗，若失败，则解除隐身状态。每人每回合第一条件与第二条件各限一次。
...
在战斗中，你可以进行忽悠行动：消耗4点基础行动点与10点SP，选定感知范围内的目标，用此技能对抗目标的心理学，如果成功，到下次目标行动时，目标的6个基础行动点听你指挥，但无法控制他对敌人使用敌意行动。限每人一次。
