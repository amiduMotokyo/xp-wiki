...
点穴|特殊战技|与武器一致|10|进行一次总伤倍率+0.5的攻击，根据击中部位让对方以一半的阈值抵抗判致伤（头部除外），该致伤效果只在1回合内有效
...
精良武具|战技|被动|0|短棍类武器最大使用次数+0.5倍，其他武器的武器威力+0.25倍，力量阈值降低10
...
震地击|特殊战技|力量|5|对攻击范围内的所有敌人造成伤害，击中部位固定为脚部，对外圈敌人总伤倍率减半
