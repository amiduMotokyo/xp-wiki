...
凝神|战技|被动|0|每次射击可额外消耗n行动点与n点SP使射击检定阈值+5n，额外伤害+n（n<=6）
远程缴械|特殊战技|与武器一致|5|若成功，造成伤害的同时，视为<a href="../../../V4.x rules/Extra/Disarm" target="_blank">缴械流程</a>中的一次对抗成功<br>本特殊战技每回合可以使用2次
...
碎甲|战技|被动|0|攻击若成功，击中的部位叠加2层<a href="../../status/mark/#裂甲印记" target="_blank">“裂甲印记”</a>，失败则叠加1层
...
破碎打|特殊战技|力量|8|若成功，击中的部位叠加4层<a href="../../status/mark/#裂甲印记" target="_blank">“裂甲印记”</a>，失败则叠加2层
