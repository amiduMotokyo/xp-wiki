...
你可以投入3点行动点，来使你到下回合你的行动开始为止获得躲避远程攻击的能力。另外，如果你在一个半掩体（指高度小于你身高的障碍物）旁边摆出蹲伏姿态，那么你可以将这个半掩体视为全掩体（指高度高于你身高的障碍物）
...
初级|你对抗直射时防守阈值不再减半
中级|你可以花费1行动点蹲下（并非蹲伏姿态），来获得将半掩体视为全掩体的效果，不结束回合，但无法移动，可以再花费1行动点起身
