...
你可以投入3点行动点，来使你到下回合你的行动开始为止获得躲避远程攻击的能力，高等级的蹲伏姿态还能使你下回合获得更加强大的射击能力。
...
初级|下回合你的射击进攻阈值衰减速度减半
中级|下回合开始你立刻免费装弹一次（装弹量可超过上限），第一次射击不消耗行动点
上级|所有敌人立刻丢失你的视野
...
初级|到下回合你的行动开始为止，你的可以代替你周围4格内的友方角色进行防御检定
中级|到下回合你的行动开始为止，你的防守阈值衰减速度减半
上级|到下回合你的行动开始为止，你无法被位移，获得一次抵消濒死/致命伤/致伤的机会
