...
15|扰乱威胁|特殊战技|与武器一致|8|若使用本战技成功造成伤害，目标在1行动轮内无法使用战术能力与子弹时间
...
25|大风车|特殊战技|与武器一致|5|本技能可以连续使用，断连后消耗本行动轮的使用次数<br>一边挥舞武器一边前进，对攻击范围内的所有敌人造成伤害，每使用一次前进1格，可以推着敌人一起前进
