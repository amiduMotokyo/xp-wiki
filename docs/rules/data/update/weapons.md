...
熟练度等级|名称|战技/特殊战技|类型/挂钩属性|消耗SP|效果
:--:|:--:|:--:|:--:|:--:|:--:
5|威震四方|战技|被动|0|任何大锤系武器的单体进攻都会让目标周围一圈的敌方单位受到伤害倍率减半的伤害（但不传递附带效果），AOE进攻阈值+12
...
25|铁龙卷|战技|被动|0|威震四方的单体进攻现在可以让目标周围2格的敌方单位受到伤害倍率减半的伤害，且可选择将该单体进攻的附带效果也传递给其他敌方单位；AOE进攻额外获得一枚奖励骰
