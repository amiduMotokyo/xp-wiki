...
中级|鏖战刻痕|选定一种武器类型，你上个回合结束后（若第一行动轮则为战斗开始后）该部位每次受击，选定的武器类型阈值+2（单一印痕最多+6）|该护甲尚未印刻鏖战刻痕且选定的武器类型熟练度至少为25
中级|孤傲刻痕|你每有一件等级大于等于8且未印刻中级刻痕的护甲，对该部位的攻击伤害倍率-0.1且自己的常规回合开始时回复3点HP与1点SP|全身护甲均未印刻孤傲刻痕
中级|轻巧刻痕|若该护甲的护甲值提升量小于等于3，则每行动轮获得0.5额外行动点|该护甲为轻甲且尚未印刻轻巧刻痕
...
上级|陷阵刻痕|受到攻击时，若该伤害来源与本行动轮对你造成过伤害的其他伤害来源均不同，则对于该伤害来源而言，本行动轮对你造成的伤害倍率减少（对你造成过伤害的不同伤害来源数量）×0.1，该效果在你的回合开始时重置|该护甲尚未印刻陷阵刻痕
...
特级|广博刻痕|该护甲的学识刻痕现在允许指定所有泛用技能；指定一项任意技能（包括特战、魔法等），该护甲每有1个与其共通挂钩属性的学识刻痕，其阈值+2，有3个以上的话（魔力则为2），再令该技能80之后的每1点“白板数值”提供0.5份价值|全身护甲已印刻至少3个学识刻痕且尚未印刻广博刻痕
特级|背水刻痕|每有一件护甲额外生命值归零，全阈值+2，该刻痕即使护甲额外生命值为0也有效果|全身护甲均至少提升过2次减伤与额外生命且尚未印刻背水刻痕
特级|超载刻痕|每场战斗限一次，该护甲受击且额外生命大于一半时可以发动，一行动轮内该护甲的护甲值变为1.5倍，减伤率+20%，持续时间结束时该护甲额外生命归零|无
特级|注能刻痕|将该护甲印刻的疾速刻痕、格挡刻痕、强韧刻痕中的“战斗结束前失效”修改为“一行动轮内失效”且效果变为两倍|该护甲已印刻疾速刻痕、格挡刻痕或强韧刻痕且尚未印刻注能刻痕
