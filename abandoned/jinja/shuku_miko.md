...
* 允许将本家的第一种<a href="/rules/V4.x rules/8·magic/#仪式之法" target="_blank">仪式之法</a>素材（各种神签）当做纸符武器的弹药使用（若没有纸符武器，视为1级的标杆纸符）。
* 你的主武器为杖系武器的场合下，若你在杖系武器的“携带模式”下施展仪式之法进入仪式时，你可以照常执行“祈愿之舞”的战斗效果，每一次执行都会额外使某一仪式之法的准备时间减少半行动轮（最多减少到半行动轮）
