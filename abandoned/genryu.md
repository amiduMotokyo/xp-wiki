...
职业等级|奖励能力
:--:|:--:
1|选定第一个子职，获得其特殊技艺、出版行动、熟练技能以及初等技能<br>授予“源流·入门”<a href="../../dan" target="_blank">段位</a>
2|获得第一个子职的中等技能<br>使用第一个子职的特殊技艺时可以获得一枚奖励骰
3|选定第二个子职，获得其特殊技艺、出版行动、熟练技能以及初等技能<br>授予“源流·切纸”<a href="../../dan" target="_blank">段位</a>
4|获得第一个子职的高等技能<br>获得第二个子职的中等技能
5|获得第二个子职的高等技能<br>使用第二个子职的特殊技艺时可以获得一枚奖励骰<br>授予“源流·兵法目录”<a href="../../dan" target="_blank">段位</a>
6|升级第一个子职的特殊技艺效果
7|升级第一个子职的初等技能<br>授予“源流·免许”<a href="../../dan" target="_blank">段位</a>
8|升级第一个子职的中等技能
9|升级第一个子职的高等技能<br>授予“源流·免许皆传”<a href="../../dan" target="_blank">段位</a>

## 子职简介

源流存在4个子职，每个子职存在各自的特殊技艺、<a href="#熟练技能" target="_blank">熟练技能</a>、出版行动，以及初等、中等、高等技能各一个。


项目|编辑|编辑|编辑|编辑
:--:|:--:|:--:|:--:|:--:
特殊技艺|美术|美术|美术|美术
<h id="熟练技能">熟练技能</h>|心理学、学习、美术、灵感|心理学、学习、美术、灵感|心理学、学习、美术、灵感|心理学、学习、美术、灵感
出版行动（校对排版）【1长休行动点】|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。
初等技能|瞩目肖像|瞩目肖像|瞩目肖像|瞩目肖像
初等技能升级|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果
中等技能|精神统一|精神统一|精神统一|精神统一
中等技能升级|每回合使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”|每回合使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”|每回合使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”|每回合使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”
高等技能|替身肖像|替身肖像|替身肖像|替身肖像
高等技能升级|替身肖像现在可最多承受2次攻击，且你现在可以选取其中的一项被动效果，令其效果+0.5倍（若最终效果带小数且不合法，则向上取整）|替身肖像现在可最多承受2次攻击，且你现在可以选取其中的一项被动效果，令其效果+0.5倍（若最终效果带小数且不合法，则向上取整）|替身肖像现在可最多承受2次攻击，且你现在可以选取其中的一项被动效果，令其效果+0.5倍（若最终效果带小数且不合法，则向上取整）|替身肖像现在可最多承受2次攻击，且你现在可以选取其中的一项被动效果，令其效果+0.5倍（若最终效果带小数且不合法，则向上取整）
...
:--:|:--:|:--:|:--:|:--:
特殊技艺|美术|美术|美术|美术
熟练技能|心理学、学习、美术、灵感|心理学、学习、美术、灵感|心理学、学习、美术、灵感|心理学、学习、美术、灵感
出版行动（校对排版）【1长休行动点】|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。|进行美术检定，完成报纸的校对排版工作，使报纸的单价增加25×（1+成功的美术检定差值因子/10）（四舍五入）文。
初等技能|瞩目肖像|瞩目肖像|瞩目肖像|瞩目肖像
初等技能升级|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果|瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果
中等技能|精神统一|精神统一|精神统一|精神统一
...
* 初等技能：瞩目肖像
* 初等技能升级：瞩目肖像现在可最多承受2次攻击，且你可以在放置时自动加入一样道具（如烟雾弹、异常瓶、炸药等），令其被破坏后释放道具效果
* 中等技能：精神统一
* 中等技能升级：每回合使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”
* 高等技能：替身肖像
* 高等技能升级：替身肖像现在可最多承受2次攻击，且你现在可以选取其中的一项被动效果，令其效果+0.5倍（若最终效果带小数且不合法，则向上取整）

奖励能力解释：

名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
瞩目肖像|战技|被动|0|消耗2行动点与一张+x的美术作品放置在周围一格作为瞩目肖像。当瞩目肖像进入某敌人的感知范围时，用肖像检定与敌人的心理学进行对抗，若成功，视为肖像对目标附加<a href="../../../../status/normal/#嘲讽" target="_blank">“嘲讽”</a>状态<br>本技能每回合对每个满足条件的敌人只进行一次判定
精神统一|战技|触发|0|每回合一次，进行一次行动或涉及检定时可选择触发，以下效果二选一：<br>额外花费1行动点与3SP，使本次行动的检定值获得-8奖励（最多-24）<br>额外花费1行动点，减少本行动的3点SP消耗
替身肖像|战技|被动|0|消耗2行动点与一张+x的美术作品放置在周围一格作为替身肖像。你可以指定你或任意队友作为替身肖像的目标，使该肖像拥有目标的一切被动效果，但是这些被动效果不可与其真身的叠加<br>你也可以指定环境物作为替身肖像的目标，不具备环境物的特性，但可以让远处的敌人误以为它是真的
...
名称|类型|挂钩属性|SP消耗|效果
:--:|:--:|:--:|:--:|:--:
讨贼檄文|战技|触发|5|每回合每一篇文学作品一次，选定一件+x的文学作品，消耗3行动点大声朗读。用文学检定与感知范围内所有敌人（或指定敌人）的心理学进行对抗，若成功，目标附加x层<a href="../../../../status/mark/#失神印记" target="_blank">“失神印记”</a>，失败则附加层数减半<br>根据讨贼檄文的风格，决定不同的失神印记上限和额外效果
...
* 完成撰稿-校对排版这两道工序后，获得一张可用于贩卖的报纸，此时可拿着这张报纸去发达城市，或是蚁族地下城市的复印工厂里进行复印工作，耗时一整天，每复印一张成本为25文，最后交给信使去贩卖。（一次最多卖100张，而且不能重复卖同样内容的报纸）
* 初等技能：闪光灯问候
* 初等技能升级：闪光灯问候每回合使用次数+1，使用范围+2
* 中等技能：摄影姿态
* 中等技能升级：姿态持续期间，敌人对抗你的识破隐形检定时阈值减半，你可以用“摄影”检定代替识破隐形中的侦查检定，若你这么做且成功识破隐形，你获得一张+（4+差值因子）品质的照片
* 高等技能：高速连拍
* 高等技能升级：使得本次摄影检定获得2枚奖励骰，检定值获得-16奖励，有50％的概率不会触发本回合和下回合禁止使用的限制
