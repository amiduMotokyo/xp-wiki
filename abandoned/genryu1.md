...
:--:|:--:|:--:
编辑|精神统一|每行动轮使用次数+1次，效果一改为“额外花费1行动点与2SP，使本次行动的检定值获得-10奖励（最多-30）”，效果二改为“额外花费1行动点，减少本行动的5点SP消耗”
...
摄影|高速连拍|使得本次摄影检定获得2枚奖励骰，检定值获得-16奖励，有50％的概率不会触发本行动轮和下行动轮禁止使用的限制
